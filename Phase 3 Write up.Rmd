...
\begin{tabular}{llllll}
    & AR(1)    & MA(2)  & ARIMA(0,1,2) & log(x) ARIMA(1,1,0) & log(x)ARIMA(1,1,1) \\
AIC & 22.62471 & 22.597 & 22.73819     & -0.1939758          & -0.1974           
\end{tabular}
\end{table}
...
tsplot(log(sum_delays$arr_del15), xlim=c(0,50), ylim=c(9,12.5))
```
